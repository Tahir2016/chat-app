...
A scalable backend service responsible for authentication, messaging, and real-time communication, designed with a modular and production-ready architecture.
...
- `name_updated` → Update user name in real-time  
